...
//  SDWeather
//
//  Created by shay deacy on 15/12/2014.
...
//                 
//                 NSDictionary *cityDict = returnedData[@"city"];
//                 NSString *cityName = cityDict[@"name"];
//                 [_cityData setCityName:cityName];
//                 
//                 NSArray *listOfDaysForecasts = returnedData[@"list"];
//                 [_cityData setDaysForecastsArray:listOfDaysForecasts];
//                 
//                 
//                 
//                 
